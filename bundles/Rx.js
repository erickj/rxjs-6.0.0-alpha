...
function throwError(error, scheduler) {
    if (!scheduler) {
        ...
        return new Observable(function (subscriber) { return scheduler.schedule(dispatch$6, 0, { error: error, subscriber: subscriber }); });
    }
}
 ...
 */
function concatMap$$1(project) {
    return concatMap$1(project)(this);
}
...
function concatMapTo$1(innerObservable) {
    return concatMap$1(function () { return innerObservable; });
}
 ...
 */
function concatMapTo$$1(innerObservable) {
    return concatMapTo$1(innerObservable)(this);
}
 ...
 */
function exhaustMap$$1(project) {
    return exhaustMap$1(project)(this);
}
 ...
 */
function first$$1(predicate, defaultValue) {
    return first$1(predicate, defaultValue)(this);
}
 ...
 */
function last$$1(predicate, defaultValue) {
    return last$1(predicate, defaultValue)(this);
}
...
function mergeMapTo$$1(innerObservable, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return mergeMapTo$1(innerObservable, concurrent)(this);
}
 ...
 */
function switchMapTo$$1(innerObservable) {
    return switchMapTo$1(innerObservable)(this);
}
